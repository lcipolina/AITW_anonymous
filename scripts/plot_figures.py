...
def plot_scatter(
    ...
    xlabel = '+' if 91 in prompt_id or  92 in prompt_id  or 93 in prompt_id else ''
    plt.xlabel(f'AIW{xlabel} Correct response rate', fontweight='bold', fontdict={ 'size': axis_fontsize})
    plt.ylabel(benchmark, fontweight='bold', fontdict={ 'size': axis_fontsize})
    plt.xticks(fontsize=axis_fontsize)
