...
├── data_collection
│   ├── examples    # examples of scripts for AIW testing and data collection via various platforms
│   ├── lmsys_tools # source code for data collection  
...
├── scripts
│   ├── execute_litellm_data_gathering.sh # example of AIW testing and data collection using litellm
│   ├── plot.py
